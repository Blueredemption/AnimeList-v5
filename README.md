...
Click [here](https://github.com/Blueredemption/AnimeList-5/releases/tag/5.0.0) to download the executable jar. The user will need Java 19 or newer JRE installed
